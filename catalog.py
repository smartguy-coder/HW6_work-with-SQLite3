NAMES_SET = ['James', 'Mary', 'Robert', 'Patricia', 'John', 'Jennifer', 'Michael', 'Linda', 'William', 'Elizabeth',
...
SURNAMES_SET = ['SMITH', 'JOHNSON', 'WILLIAMS', 'BROWN', 'JONES', 'MILLER', 'DAVIS', 'GARCIA', 'RODRIGUEZ', 'WILSON',
...
POSITIONS_SET = ["manager", "teacher", "secretary", "driver", "translator", "director", "saler"]
